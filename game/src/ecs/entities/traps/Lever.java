...
/**
 * The lever extends the functionality of the teleporter trap. Can be used to activate or deactivate
 * the teleporter.
 */
public class Lever extends Entity {
    ...
    private Animation moveAI =
            AnimationBuilder.buildAnimation("traps/lever/lever_moving_active-inactive", 1, false);
    private Animation moveIA =
            AnimationBuilder.buildAnimation("traps/lever/lever_moving_inactive-active", 1, false);
    private Animation active =
            AnimationBuilder.buildAnimation("traps/lever/lever_active", 1, false);
    private Animation inactive =
            AnimationBuilder.buildAnimation("traps/lever/lever_inactive", 1, false);
