...
/**
 * The Mage is a playable character which has the following skills: - Fireball - Frostbolt -
 * Teleport
 *
 * <p>This character class is the only one to own a ManaComponent.
 */
public class Mage extends Hero {
    ...
    /** Default constructor for a Mage Hero */
    public Mage() {
    ...
    private void setupSkills() {
        ...
        // Teleport
        thirdSkill = new Skill(new TeleportSkill(5), 5, TeleportSkill.pathToTextureUI);
